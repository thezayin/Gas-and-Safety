 ...
 */
interface GetAreaListUseCase : suspend (GetAreaListParams) -> Flow<Response<List<String>>>
...
class GetAreaListUseCaseImpl(
     ...
     * @return A [Flow] emitting a [Response] containing a list of area names on success
     *         or an error message on failure.
     */
    override suspend fun invoke(params: GetAreaListParams): Flow<Response<List<String>>> = flow {
        ...
        try {
            ...
            emit(Response.Error("Failed to retrieve areas for city '${params.city}': ${e.localizedMessage}"))
        }
